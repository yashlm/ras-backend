		  ...
		  <tbody>
			<tr style="width:100%">
			  <td>
				...
				<p style="font-size:20px;line-height:28px;margin:16px 0;margin-bottom:30px">{{.Body}}</p>
				<p style="font-size:14px;line-height:24px;margin:16px 0;color:#000">This is an auto-generated email. Please do not reply.</p>
...
<meta content="text/html; charset=UTF-8" http-equiv="Content-Type" />
<html dir="ltr" lang="en">
<!-- Recruited email template content -->
</html>`
)
